Feature: Cadastro de usuários
  ...
  Scenario: Cadastrar usuário com sucesso
    ...
    Then a resposta da requisição POST do cadastro de usuario deve ter o status code 201
  ...
  Scenario: Cadastrar usuário com email já cadastrado
    ...
    When faço uma requisição POST para cadastrar um usuario com os seguintes dados:
      | username | email          | password |
      | John  | john.doe@email.com| 123456   |
    Then a resposta da requisição POST do cadastro de usuario deve ter o status code 400
  ...
  Scenario: Trazer os dados de um usuário
    ...
    Then a resposta da requisição GET do cadastro de usuario deve ter o status code 200
    And os dados de usuário retornados devem estar corretos

  Scenario: Buscar usuário inexistente
    Given que eu ainda não sou cadastrado
    When faço uma requisição GET para trazer os dados do usuário inexistente
    Then a resposta da requisição GET do cadastro de usuario deve ter o status code 404

  Scenario: Deletar usuário
    Given que eu sou um usuário cadastrado
    When faço uma requisição DELETE para deletar o usuário existente
    Then a resposta da requisição DELETE do cadastro de usuario deve ter o status code 204
  ...
  Scenario: Deletar usuário inexistente
    ...
    Then a resposta da requisição DELETE do cadastro de usuario deve ter o status code 404